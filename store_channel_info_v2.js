module.exports = {
	...
	subtitle: function(data) {
		...
		const info = ["Channel Object", "Channel ID", "Channel Name", "Channel Topic", "Channel Last Message", "Channel Position", "Channel Is NSFW?", "Channel Is DM?", "Channel Is Deleteable?", "Channel Creation Date", "Channel Category ID", "Channel Created At", "Channel Created At Timestamp", "Channel Current Slowmode", "Channel Type", "Channel Category"];
	...
	variableStorage: function(data, varType) {
		...
		switch(info) {
			...
			case 12:
				...
				break;
                        case 13:
				dataType = "Channel Current Slowmode";
				break;
                        case 14:
				dataType = "Channel Type";
				break;
                        case 15:
				dataType = "Channel Category";
				break;
		}
	...
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="3">Channel Topic</option>
                        ...
                        <option value="13">Channel Current Slowmode</option>
			...
			<option value="12">Channel Creation Timestamp</option>
                        <option value="15">Channel Category</option>
